module.exports = {
  character: {
    ...
    feet_texture_path: "character/feet.png",
    hair_styles: [
      {
        id: "swept_right",
        name: "Swept Right",
    ...
    feet: [
      {
        id: "leather_boots",
        name: "Leather Boots",
        equipped_texture_path: "equipment/feet/leather-boots/equipped.png",
        stats: {
          melee_accuracy: 2,
          melee_strength: 0,
          melee_defense: 2,
      ...
      },
      {
        id: "sabatons",
        name: "Sabatons",
        equipped_texture_path: "equipment/feet/sabatons/equipped.png",
        stats: {
          melee_accuracy: -2,
          melee_strength: 0,
          melee_defense: 10,
